...
import com.atyichen.yiojbackendcommon.annotation.AuthCheck;
import com.atyichen.yiojbackendcommon.common.BaseResponse;
import com.atyichen.yiojbackendcommon.common.DeleteRequest;
import com.atyichen.yiojbackendcommon.common.ErrorCode;
import com.atyichen.yiojbackendcommon.common.ResultUtils;
...
import com.atyichen.yiojbackendmodel.model.dto.question.QuestionAddRequest;
import com.atyichen.yiojbackendmodel.model.dto.question.QuestionEditRequest;
import com.atyichen.yiojbackendmodel.model.dto.question.QuestionQueryRequest;
import com.atyichen.yiojbackendmodel.model.dto.question.QuestionUpdateRequest;
...
public class QuestionController {
    ...
    // 这是question对外提供的服务， 对于question的服务来说， 肯定是最高的权限
    // 对于userService的服务， 只能使用userService对内部提供的服务， 即 UserInnerController
    @Resource
    ...
    public BaseResponse<Long> addQuestion(@RequestBody QuestionAddRequest questionAddRequest, HttpServletRequest request) {
        ...
        // 这里是对questionAddRequest中的tags做了封装，我没有做
...
//        }
    ...
    public BaseResponse<QuestionVO> getQuestionVOById(long id, HttpServletRequest request) {
        ...
        // test userFeignClient
        User loginUser = userFeignClient.getById(id);
